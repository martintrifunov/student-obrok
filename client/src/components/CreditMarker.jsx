      ...
      <Popup>
        <Box style={popupStyle}>
          ...
          <Typography variant="p" textAlign="left">
            <strong>Студентски Оброк</strong>, развиен од <strong>Мартин Трифунов</strong>, е веб апликација
            дизајнирана да помогне на студентите во наоѓањето на економични
            оброци за ручек на удобен начин. Со нудење на корисен интерфејс, ја
            упрости процедурата за наоѓање на блиски ресторани со попусти, во
